...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'orders.approve', 'module' => 'orders', 'description' => 'Approve orders'],
            ['name' => 'production.manage', 'module' => 'production', 'description' => 'Manage production'],
            ['name' => 'procurement.create_po', 'module' => 'procurement', 'description' => 'Create purchase orders'],
            ...
            ['name' => 'inventory.manage_products', 'module' => 'inventory', 'description' => 'Manage products'],
            ['name' => 'inventory.manage_stock', 'module' => 'inventory', 'description' => 'Manage stock'],
        ...
        $defaultPriceList = \App\Models\PriceList::create([
